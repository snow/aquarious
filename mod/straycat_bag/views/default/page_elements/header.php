...
<?php
	/*
	 * MOD START by Snow
	 * mods could extend view js to load js for it.
	 */
?>
	<script type="text/javascript" src="<?php echo $vars['url']; ?>mod/straycat_bag/js/straycat_bag.js"></script>
	<script type="text/javascript">
		site_url = "<?php echo $vars['url']; ?>";
	</script>
<?php
	echo elgg_view('loadjs');
	/*
	 * MOD END by Snow
	 */ 
	global $pickerinuse;
