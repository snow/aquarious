...
?>
	...
	<form action="<?php echo $vars['url']; ?>action/messages/send" method="post" name="messageForm">
        ...
        ?>
    	    ...
    	    <select name='send_to' id="select4picker">
    	    <?php 
    	        ...
    	        foreach($vars['friends'] as $friend){
    			    ...
    			    echo "<option id=\"opt-{$friend->guid}\" value='{$friend->guid}'>" . $friend->name . "</option>";
    			        
    		    }
    		        
            ?>
    		</select>&nbsp;
    		<a id="toggle_picker" style="display:none;" href=""><?php echo elgg_echo('messages:toggle_picker');?></a>
    		</p>   		
    		
    		    
        <?php
    		echo elgg_view('friends/picker',array('entities'=>$vars['friends']));
    		
	        }//end send_to if statement
		    /*
		     * MOD START by Snow
		     * TODO purpose of the mod
		     *
		     * ORIGIN START
